  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-400 mt-1">Review and process user verification requests</p>
      </div>
          ...
          {filteredVerifications.map((verification) => {
            ...
            return (
              <Card
                ...
                className={cn(
                  selectedVerification?.id === verification.id && 'border-primary-500'
                )}
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className={cn(
                    ...
                    verification.userType === 'TENANT' && 'bg-blue-500/10 text-blue-400',
                    verification.userType === 'LANDLORD' && 'bg-success/10 text-success',
                    verification.userType === 'AGENT' && 'bg-warning/10 text-warning'
                  )}>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        ...
                        <p className="text-sm text-gray-400 mt-0.5">{verification.userEmail}</p>
                      </div>
        ...
        <div className="lg:col-span-1">
          {selectedVerification ? (
              ...
              <CardContent className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="text-white font-medium">{selectedVerification.userName}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-400">Email</span>
                      <span className="text-white">{selectedVerification.userEmail}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-400">Type</span>
                      <span className="text-white">{selectedVerification.userType}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-400">LGA</span>
                      <span className="text-white">{selectedVerification.lgaName}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-400">Properties</span>
                      <span className="text-white">{selectedVerification.propertyCount}</span>
                    </div>
                  </div>
                </div>
                ...
                {selectedVerification.notes && (
                  <div>
                    ...
                    <p className="text-sm text-gray-300">{selectedVerification.notes}</p>
                  </div>
                )}
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">{formatDate(selectedVerification.submittedAt)}</p>
                      </div>
                    </div>
                    {selectedVerification.reviewedAt && (
                      <div className="flex items-start gap-3">
                        <div className={cn(
                          ...
                          selectedVerification.status === 'APPROVED' ? 'bg-success' : 'bg-danger'
                        )} />
                        <div>
                          ...
                          <p className="text-xs text-gray-500">
                            {formatDate(selectedVerification.reviewedAt)} by {selectedVerification.reviewedBy}
                          </p>
                        </div>
                      </div>
                    )}
            ...
            <Card padding="lg" className="text-center">
              ...
              <p className="text-gray-400 mt-4">Select a verification request to view details</p>
            </Card>
          )}
        </div>
      </div>
